$(function(){
		...
		$(document).on('click','.view', function(){
           ...
           console.log(user_id);
			$.post('intel/ajax/reviews.php', {showPopup:sweat_id,user_id:user_id}, function(data){
				$('.popupView').html(data);
	...
	$(document).one('click', '.view-it', function(event){
       ...
       var view ;
	    ...
	    $.post('intel/ajax/reviews.php', {qoute:sweat_id,user_id:user_id,view:view}, function(data){
    ...
    $(document).on('click','.reply', function(){
       ...
       console.log(sweat_id);
       console.log(user_id);
        $.post('../intel/ajax/reviews.php', {showReply:sweat_id,user_id:user_id}, function(data){
            $('.popupView').html(data);
...
$(document).one('click', '.reply-it', function(event){
   ...
   var view ;
    ...
    $.post('../intel/ajax/reviews.php', {reply:view_id,user_id:user_id,view:view}, function(data){
